...
class validarOfertaTest {
    @Test
    public void validarOfertaTest() throws IOException, ClassNotFoundException {
...
class buscarYComprarOfertaTest {
    @Test
    public void buscarYComprarOfertaTest() throws IOException {
        String data =
                "\n" +
                        "1" + //entrar al menu para registrarse
                        "\n" +
